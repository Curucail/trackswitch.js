...
const ICON_SVG_BY_NAME: Record<TrackSwitchIconName, string> = {
    'loop-a': '<svg class="ts-icon-svg" role="img" viewBox="0 0 24 24" aria-hidden="true"><rect x="2.5" y="2.5" width="19" height="19" rx="2.5" ry="2.5" fill="none" stroke="currentColor" stroke-width="1.5"></rect><path d="M8.8 16.7L12 7.6L15.2 16.7M9.8 13.9H14.2" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"></path></svg>',
    'loop-b': '<svg class="ts-icon-svg" role="img" viewBox="0 0 24 24" aria-hidden="true"><rect x="2.5" y="2.5" width="19" height="19" rx="2.5" ry="2.5" fill="none" stroke="currentColor" stroke-width="1.5"></rect><path d="M9.3 7.6V16.4M9.3 7.6H12.6C14.1 7.6 15.1 8.4 15.1 9.7C15.1 10.9 14.3 11.6 12.9 11.7M9.3 11.7H13C14.6 11.7 15.6 12.5 15.6 14C15.6 15.5 14.5 16.4 12.7 16.4H9.3" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"></path></svg>',
