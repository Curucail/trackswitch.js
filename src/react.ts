...
export const TrackSwitchAlignmentPlayer = createTrackSwitchReactComponent(
	"trackswitch-alignment-player",
);

export const TrackSwitchAlignmentInteractive = forwardRef(
	function TrackSwitchAlignmentInteractive(
